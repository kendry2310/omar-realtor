(function () {
  ...
  window.__BRAND__ = {
    ...
    areas: [
      ...
      { id: "area-miami", name: "Miami", photo: "assets/img/city-miami.webp", alt: "Miami, Florida — skyline sobre Biscayne Bay" },
      ...
      { id: "area-hialeah", name: "Hialeah", photo: "assets/img/city-hialeah.webp", alt: "Hialeah, Florida — puente histórico junto al canal" }
    ],
